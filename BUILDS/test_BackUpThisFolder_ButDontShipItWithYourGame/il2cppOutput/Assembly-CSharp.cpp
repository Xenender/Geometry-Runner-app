...
struct obstacles_t9B6B58B8A1146CF13C3047EDBF216BD9BBC51126  : public MonoBehaviour_t532A11E69716D348D8AA7F854AFCBFCB8AD17F71
{
	...
	float ___speed_4;
	// TMPro.TextMeshProUGUI obstacles::text
...
// System.Void obstacles::ReloadScene()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void obstacles_ReloadScene_m0785923E3274469465D82287B1A6E44FD51482DF (obstacles_t9B6B58B8A1146CF13C3047EDBF216BD9BBC51126* __this, const RuntimeMethod* method) 
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void obstacles_OnCollisionEnter_m34E193BECC51AA74E5C7284A666DF63B03D79F8A (obstacles_t9B6B58B8A1146CF13C3047EDBF216BD9BBC51126* __this, Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* ___collisionInfo0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_4 = ___collisionInfo0;
		NullCheck(L_4);
		...
		MonoBehaviour_Invoke_mF724350C59362B0F1BFE26383209A274A29A63FB(__this, _stringLiteralB119AB8CF4D7611CB5CB2DAB6E4DCB3DDCA32098, (2.0f), NULL);
		// print("sa");
		MonoBehaviour_print_mED815C779E369787B3E9646A6DE96FBC2944BF0B(_stringLiteral5204BE9DC83E65F70358D48FB17D94E257C49CE8, NULL);
	}

IL_005c:
	{
		// if(collisionInfo.gameObject.name == "Out")
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_10 = ___collisionInfo0;
		NullCheck(L_10);
		...
		bool L_13;
		L_13 = String_op_Equality_m0D685A924E5CD78078F248ED1726DA5A9D7D6AC0(L_12, _stringLiteralAF61C1EE535DDF446AAFABFE654FBB224655AE44, NULL);
		if (!L_13)
		{
			goto IL_00a3;
		}
	}
	{
		...
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_14 = __this->___text_5;
		NullCheck(L_14);
		String_t* L_15;
		...
		TextMeshProUGUI_t101091AF4B578BB534C92E9D1EEAF0611636D957* L_17 = __this->___text_5;
		String_t* L_18;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void player_movement_Update_m5AECA3C0927424ACEE1FDBFEBEF1D7852ABBF561 (player_movement_tFD8B35B9C8850BC5F24EE73CC2042A302036B5D3* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Touch_t03E51455ED508492B3F278903A0114FA0E87B417* L_8 = (&__this->___touch_4);
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_18), ((float)il2cpp_codegen_add(L_7, ((float)il2cpp_codegen_multiply(L_10, L_11)))), L_14, L_17, /*hidden argument*/NULL);
		NullCheck(L_4);
...
IL_007d:
	{
		...
		float L_22 = __this->___posXmax_7;
	...
	}
	{
		...
		float L_24 = __this->___posXmax_7;
...
IL_00cc:
	{
		...
		float L_35 = __this->___posXmin_6;
	...
	}
	{
		...
		float L_37 = __this->___posXmin_6;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void spawner_Start_mBC447EE34AA7B3F281F8797DFB070B3DAC76F375 (spawner_t8EC5D03E983AA5844F495A06CE829F4A074FC209* __this, const RuntimeMethod* method) 
{
	...
	{
		// InvokeRepeating("spawnObstacle",4,1.5f); //appelle au bout de 4secondes et toutes les 4 secondes
		MonoBehaviour_InvokeRepeating_mF208501E0E4918F9168BBBA5FC50D8F80D01514D(__this, _stringLiteral1FF67EFB70AAEE20439BEAF5F11F66371CC11228, (4.0f), (1.5f), NULL);
		// }
		return;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void spawner_spawnObstacle_mE73ECAA8145963B18B1A3895F7F4E7E9D46E441E (spawner_t8EC5D03E983AA5844F495A06CE829F4A074FC209* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_0 = __this->___obstacle_4;
		TransformU5BU5D_tBB9C5F5686CAE82E3D97D43DF0F3D68ABF75EC24* L_1 = __this->___pos_5;
